package com.freecodeofficial.videodownloaderapp.adapters;
...
public class DownloadsAdapter extends RecyclerView.Adapter<DownloadsAdapter.SavedHolder> {
    ...
    public void onBindViewHolder(@NonNull SavedHolder holder, final int position) {
        ...
        holder.fileThumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri fileUri = FileProvider.getUriForFile(context, "com.freecodeofficialt.videodownloaderapp.fileprovider", list.get(position));
    ...
    private void shareFile(final File f) {
        ...
        Uri fileUri = FileProvider.getUriForFile(context, "com.freecodeofficial.videodownloaderapp.fileprovider", file);
