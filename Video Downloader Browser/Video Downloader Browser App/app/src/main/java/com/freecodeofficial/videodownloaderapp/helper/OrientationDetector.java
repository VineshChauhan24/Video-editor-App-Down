package com.freecodeofficial.videodownloaderapp.helper;
                ...
                public void onOrientationChanged(int orientation) {
                    ...
                    if (currDirection != lastDirection) {
                        ...
                        if (holdingTime > HOLDING_THRESHOLD) {
                            ...
                            } else if (currDirection == Direction.REVERSE_LANDSCAPE && currentOrientation != ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE) {
