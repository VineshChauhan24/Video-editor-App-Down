package com.freecodeofficial.videodownloaderapp.views;
...
import com.freecodeofficial.videodownloaderapp.helper.OrientationDetector;

import java.io.IOException;
import java.util.Map;

public class CustomVideoView extends SurfaceView
        implements CustomMediaController.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    private String videoTag = "UniversalVideoView";
    ...
    public CustomVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.CustomVideoView,0,0);
    ...
    MediaPlayer.OnVideoSizeChangedListener mSizeChangedListener =
            new MediaPlayer.OnVideoSizeChangedListener() {
                public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
                    ...
                    Log.d(videoTag, String.format("onVideoSizeChanged width=%d,height=%d", mVideoWidth, mVideoHeight));
                    if (mVideoWidth != 0 && mVideoHeight != 0) {
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
            new MediaPlayer.OnErrorListener() {
                public boolean onError(MediaPlayer mp, int frameworkErr, int implErr) {
                    ...
                    return mOnErrorListener.onError(mMediaPlayer, frameworkErr, implErr);
                }
            };
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(CustomVideoView.this);
